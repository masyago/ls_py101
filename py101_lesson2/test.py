...
if user_choice in VALID_LETTERS:
    chose_index = VALID_LETTERS.index(user_choice)
    match_user_choice = VALID_WORDS[chose_index]
    print(f'You chose {match_user_choice}')